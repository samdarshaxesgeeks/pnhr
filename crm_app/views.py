...
def add_new_contact(request):
    if request.method == 'POST':
        ...
        customerdetails = CustomerDetails(customer=customer,c_date_of_birth=c_date_of_birth,age=age,division=division,county=county,sub_county=sub_county,parish=parish,village=village,address=address,telephone=telephone, )
